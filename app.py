...
password = "HikkyS123"
cxn_str = f"mongodb+srv://deva:{password}@cluster0.lqhsg9q.mongodb.net/?retryWrites=true&w=majority"
...
def detail(keyword):
    api_key = "53c37871-0443-4e50-8c82-ce4c849cc354"
...
def delete_ex():
    ...
    return jsonify({
        'result': 'success',
        'msg': f'Your examples for the word, {word}, was deleted!',    
    })
